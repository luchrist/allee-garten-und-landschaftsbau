    ...
    <LegalLayout label="Datenschutz" title="Datenschutz">
      ...
      <Section title="6. Kontaktaufnahme per WhatsApp">
        <p>
          ...
          telefonisch oder über das Anfrageformular an uns gerichtet werden.
        </p>
      </Section>

      <Section title="7. Kontaktaufnahme">
        <p>
          Bei der Kontaktaufnahme per Telefon oder WhatsApp werden die von Ihnen mitgeteilten Daten (Name, Anfrage,
