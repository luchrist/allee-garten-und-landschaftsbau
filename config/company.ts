...
export const company = {
  ...
  socialMedia: {
    ...
    hidden: {
      ...restaurant.socialMedia.hidden,
      // Die generierte Facebook-URL ist Template-Rest und zeigt auf einen fremden
      // Betrieb. Bestätigt ist nur das Instagram-Profil aus den Akquisedaten.
      facebook: true
    }
  },
